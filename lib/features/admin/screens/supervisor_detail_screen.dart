        ...
        slivers: [
          AppLargeTopBar(
            ...
            actions: [
              ...
              // chrome, mirroring TeacherDetailScreen. The setUserPassword
              // Cloud Function already authorizes super_admin → any user.
            ...
            data: (supervisor) {
              if (supervisor == null) {
                return const SliverFillRemaining(
                  hasScrollBody: false,
                  child: Center(child: Text('المشرف غير موجود')),
                );
              }
